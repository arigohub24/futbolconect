...
const Marketplace = () => {
  ...
  // Simulate counter animation for deals
  useEffect(() => {
    let count = 0;
    const target = 7500;
    const increment = 75;
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl font-bold text-gray-800">The Marketplace</h1>
      ...
      >
        <h2 className="text-2xl font-semibold mb-6">Top Leagues on TransferRoom</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {leagues.map((league, index) => (
            <motion.div
              ...
              className={`${league.color} p-5 rounded-xl text-center cursor-pointer transition-all ${activeLeague === index ? 'ring-2 ring-blue-500' : ''}`}
            >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-semibold">Deals Facilitated on TransferRoom</h2>
