      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-blue-800 mb-6 max-w-2xl mx-auto">
            Information about our use of cookies and GDPR compliance. Learn how we protect your data.
          </p>
        </div>
          ...
          <div className="space-y-6">
            {cookieTypes.map((cookie, index) => (
              <motion.div
                ...
                className="border border-blue-100 rounded-lg p-5 bg-blue-50 shadow-md hover:shadow-lg"
              >
        ...
        >
          ...
          <div className="prose prose-blue">
            <p className="text-blue-800 mb-4">
              Futbol Conect is fully compliant with the General Data Protection Regulation (GDPR). This regulation gives
            ...
            <p className="text-blue-800">
              ...
              <span className="font-medium">dpo@futbolconect.com</span>.
            </p>
          </div>
        </motion.div>
      </div>
