...
const ChooseStandalone = () => {
  ...
  const plan = {
    name: "Pro Standalone",
    durations: [
      { months: 24, price: "£8,700", note: "1st year" },
      ...
      >
        <div className="bg-white rounded-xl shadow-sm p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for subscribing to TransferRoom Pro Standalone. Your account is now active.
          </p>
          <button
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
          <div className="p-6 md:p-8">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
              Complete Your Pro Standalone Subscription
            </h1>
            <p className="text-gray-600 mb-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <div className="pt-2">
                  ...
                  >
                    {isProcessing ? 'Processing...' : `Pay ${duration === 24 ? '£8,700' : '£6,600'}`}
                  </button>
                </div>
              </div>
            </form>
