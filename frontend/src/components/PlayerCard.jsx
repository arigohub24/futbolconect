  ...
  return (
    <>
      <motion.div
        ...
        className="bg-gradient-to-b from-white to-blue-50 rounded-xl shadow-md overflow-hidden border border-blue-100 cursor-pointer"
      >
            ...
            >
              <div className="relative">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => setIsExpanded(false)}
                  className="absolute right-4 top-4 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:text-gray-800"
                >
                ...
                {/* Player Image */}
                <div className="h-64 bg-gradient-to-b from-blue-200 to-blue-100 flex items-center justify-center overflow-hidden">
                  <img
                    src={player.image || `https://via.placeholder.com/400x300?text=${player.name}`}
                    alt={player.name}
                ...
                {/* Player Details */}
                <div className="p-6">
                  <h2 className="text-2xl font-bold text-blue-900 mb-4">{player.name}</h2>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-blue-900">{player.position || 'Not specified'}</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-gray-600">
                      {player.bio || `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ${player.name} has shown exceptional performance in recent seasons.`}
                    </p>
                  </div>
                </div>
