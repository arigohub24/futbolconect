      ...
      <AnimatePresence mode="wait">
        <Routes>
          ...
          <Route element={<ProtectedLayout />}>
            ...
            <Route path="/recruitment" element={authUser ? <Recruitment /> : <Navigate to="/login" />} />
            <Route path="/outplacement" element={authUser ? <Outplacement /> : <Navigate to="/login" />} />
            <Route path="/settings" element={authUser ? <Settings /> : <Navigate to="/login" />} />
            <Route path="/player/:id" element={authUser ? <PlayerProfile /> : <Navigate to="/login" />} />
            <Route
            ...
            <Route path="/activity" element={authUser ? <Activity /> : <Navigate to="/login" />} />
            <Route path="/stats/clubs" element={authUser ? <ClubsStats /> : <Navigate to="/login" />} />
            <Route path="/stats/deals" element={authUser ? <DealsStats /> : <Navigate to="/login" />} />
            <Route path="/stats/players" element={authUser ? <PlayersStats /> : <Navigate to="/login" />} />
            <Route
              path="/create-search-advert"
              element={authUser ? <CreateSearchAdvert /> : <Navigate to="/login" />}
            />
            <Route path="/browse-leagues" element={authUser ? <BrowseLeagues /> : <Navigate to="/login" />} />
            <Route path="/connect-clubs" element={authUser ? <ConnectClubs /> : <Navigate to="/login" />} />
            <Route path="/view-stats" element={authUser ? <ViewStats /> : <Navigate to="/login" />} />
            <Route path="/join" element={authUser ? <Join /> : <Navigate to="/login" />} />
          </Route>

          {/* Protected Routes without Sidebar */}
          <Route element={<NoSidebarLayout />}>
            <Route path="/okaka" element={authUser ? <Okaka /> : <Navigate to="/login" />} />
            ...
            />
            <Route path="/profile/edit" element={authUser ? <EditProfile /> : <Navigate to="/login" />} />
          </Route>
